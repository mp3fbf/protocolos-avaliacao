...
- Identificar a seção do texto onde a informação está presente
...
- Identificar a localização no fluxograma
...
- Citar a pergunta específica do protocolo
...
- Citar o ponto de decisão específico
